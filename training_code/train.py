...
def main(_):
  ...
  print(f"Num Training  {number_training_iterations}")
  ...
  print("model_head below")
  
  print("model_head below")
  print(type(model_head))
  tf.print(vision_model)
  ######################   Load the datasets   ###############################
  ...
  #dset_train = dset_train.repeat().shuffle(10).batch(10)
  
  dset_val_list = []
  print(f"EVAL {eval_every}")
  print(f"Dset {type(dset_train)}")
