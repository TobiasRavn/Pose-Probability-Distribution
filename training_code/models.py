...
class ImplicitSO3(tfkl.Layer):
  ...
  def __init__(self, len_visual_description,
    ...
    print(f"Sampling mode {self.so3_sampling_mode}\n Frequensices {self.frequencies}\n Furia {self.number_fourier_components}\n Train Qur {self.number_train_queries}\n eval quar{self.number_eval_queries}")
